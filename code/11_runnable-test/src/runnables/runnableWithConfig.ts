...
const checkPermissionByRole = RunnableLambda.from(async (state: any, config) => {
...
const formatNotificationByLocale = RunnableLambda.from(async (state: any, config) => {
