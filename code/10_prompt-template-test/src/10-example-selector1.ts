...
/*
    演示：使用 LengthBosedExampleSelector 自动选择《长度合适》的 few-shot 示例
*/
...
// 4. 基于 selector 构建 FewShotPromptTemplate
...
// 5. 演示：给定一个较长/较复杂的需求，让 selector 自动选出合适的示例
