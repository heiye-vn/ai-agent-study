...
/*
    在 ChatPromptTemplate 中通过 MessagesPlaceholder 注入《对话历史》
*/
...
// 1. 定义一个包含 MessagesPlaceholder 的 ChatPromptTemplate
const chatPromptWithHistory = ChatPromptTemplate.fromMessages([
  ['system', '你是一名资深工程效率顾问，善于在多轮对话的上下文中给出具体、可执行的建议。'],
  // 使用 MessagesPlaceholder 来承载《之前的多轮对话》
  new MessagesPlaceholder('history'),
  ['human', '这是用户本轮的新问题：{current_input} 请结合上面的历史对话，一并给出你的建议。'],
]);
